                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Silahkan ditambahkan Data Rumah</h6>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo site_url('rumah/proses_tambah'); ?>" method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="tipe_rumah">Tipe Rumah:</label>
                                    <input type="text" name="tipe_rmh" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="foto_rmh" class="form-control" accept="image/*" required>
                                </div>
                                <div class="mb-3">
                                    <label for="kondisi">Kondisi:</label>
                                    <input type="text" name="kondisi" class="form-control" required>
                                </div>
                                <button type="submit" class="btn btn-primary" value="upload" class="btn btn-primary">Tambah Data Rumah</button>
                            </form>
                        </div>
