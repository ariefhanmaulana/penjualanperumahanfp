                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Silahkan ditambahkan Data Customer</h6>
                        </div>
                        <div class="card-body">
                            <form action="<?php echo site_url('customer/aksi_simpancus'); ?>" method="POST">
                                  <div class="mb-3">
                                    <label for="NIM" class="form-label">Nama Customer</label>
                                    <input type="text" class="form-control" name="nmcus" id="nmcus" required>
                                  </div>
                                  <div class="mb-3">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamcus" id="alamcus" required></textarea>
                                  </div>
                                  <div class="mb-3">
                                    <label for="Email" class="form-label">Pekerjaan</label>
                                    <input type="text" class="form-control" name="pkj" id="pkj" required>
                                  </div>
                                  <div class="mb-3">
